...
export class UserDetailsEffects {
  ...
  fetchUserDetailsEFFECT$: Observable<Action> = createEffect(() =>
    this.actions$.pipe(
        ...
        return this.fireStore
          ...
          .pipe(
            ...
            catchError((error: Error) => {
              ...
              return of(
                userDetailActions.onUserDetailFailure({ error: error })
              );
            })
          );
      })
        ...
        return this.fireStore
          ...
          .then(() => {
            this.sharedService.openSnackBar(
              'User details added successfuly',
              'Ok'
            );
  ...
  updateUserDetailEffect$: Observable<Action> = createEffect(() =>
    this.actions$.pipe(
  ...
  deleteUserDetailEFFEET$: Observable<Action> = createEffect(() =>
    this.actions$.pipe(
